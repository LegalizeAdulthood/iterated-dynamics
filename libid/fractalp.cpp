...
fractalspecificstuff g_fractal_specific[] =
{
    ...
    */
    ...
    {
        "celtic",
        {realz0, imagz0, "degree", ""}, {0, 0, 2, 0}, help_labels::HT_MANDEL, help_labels::HF_MANDEL,
    ...
    {
        "talis",
        {realz0, imagz0, "degree", "m"}, {0, 0, 2, 1}, help_labels::HT_MANDEL, help_labels::HF_MANDEL,
    ...
    {
        "newton_apple",
        {realz0, imagz0, "degree", ""}, {0, 0, 4, 0}, help_labels::HT_MANDEL,
        help_labels::HF_MANDEL,
        fractal_flags::BAILTEST,
    ...
    {
        "newton_polygon",
        {realz0, imagz0, "degree", ""}, {0, 0, 6, 0}, help_labels::HT_MANDEL,
        help_labels::HF_MANDEL,
        fractal_flags::BAILTEST,
    ...
    {
        "nova",
        {realz0, imagz0, "", ""}, {0, 0, 0, 0}, help_labels::HT_MANDEL, help_labels::HF_MANDEL,
        fractal_flags::BAILTEST,
        -2.5F, 2.5F, -2.0F, 2.0F, 0,
    ...
    {
        "newton_flower",
        {realz0, imagz0, "degree", ""}, {0, 0, 5, 0}, help_labels::HT_MANDEL,
        help_labels::HF_MANDEL,
        fractal_flags::BAILTEST,
        -2.5F, 2.5F, -2.0F, 2.0F, 0,
    ...
    {
        "quartet",
        {realz0, imagz0, "degree", "version (1-6)"}, {0, 0, 4, 6}, help_labels::HT_MANDEL,
        help_labels::HF_MANDEL,
        fractal_flags::BAILTEST,
        -2.5F, 2.5F, -2.0F, 2.0F, 0,
    ...
    {
        "artmatrixcubic",
        {"subtype (0-3)", "special colour", "", ""}, {0, 2, 0, 0}, help_labels::HT_MANDEL,
        help_labels::HF_MANDEL,
        fractal_flags::BAILTEST,
