...
#define USE_BN
#ifdef USE_BN
    {FractalType::JULIA, BFMathType::BIG_NUM, julia_bn_fractal, julia_bn_per_pixel,  mandel_bn_setup},
    {FractalType::MANDEL, BFMathType::BIG_NUM, julia_bn_fractal, mandel_bn_per_pixel, mandel_bn_setup},
#else
    ...
    */
    {FractalType::JULIA_Z_POWER, BFMathType::BIG_FLT, julia_z_power_bf_fractal, julia_bf_per_pixel, mandel_bf_setup},
    {FractalType::MANDEL_Z_POWER, BFMathType::BIG_FLT, julia_z_power_bf_fractal, mandel_bf_per_pixel, mandel_bf_setup},
...
FractalSpecific g_fractal_specific[] =
{
    ...
    */

    {
        ...
        SymmetryType::NONE,                                        //
        newton_fractal2, other_julia_per_pixel, newton_setup,      //
        standard_fractal,                                          //
        NO_BAILOUT                                                 //
    },
...

    {
        ...
        SymmetryType::ORIGIN,                                                  //
        julia_orbit, julia_per_pixel, julia_fp_setup,                          //
        standard_fractal,                                                      //
        STD_BAILOUT                                                            //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                                  //
        SymmetryType::NONE,                                                                                //
        nullptr, nullptr, standalone_setup,                                                                //
        plasma,                                                                                            //
        NO_BAILOUT                                                                                         //
    },

    {
        ...
        lambda_trig_fp_fractal, other_mandel_per_pixel, mandel_trig_setup, //
        standard_fractal,                                                  //
        TRIG_BAILOUT_L                                                     //
    },
...

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                //
        SymmetryType::X_AXIS,                                            //
        sqr_trig_fp_fractal, other_julia_per_pixel, sqr_trig_setup,      //
        standard_fractal,                                                //
        TRIG_BAILOUT_L                                                   //
    },
...

    {
        ...
        {"", "", "", ""},                                                  //
        {0, 0, 0, 0},                                                      //
        HelpLabels::HT_TAYLOR_SKINNER_VARIATIONS, HelpLabels::HF_FN_Z_SQR, //
        FractalFlags::TRIG1 | FractalFlags::BAIL_TEST,                     //
        -4.0F, 4.0F, -3.0F, 3.0F,                                          //
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                  //
        SymmetryType::XY_AXIS,                                             //
        trig_z_sqrd_fp_fractal, julia_per_pixel, julia_fp_setup,           //
        standard_fractal,                                                  //
        STD_BAILOUT                                                        //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                                //
        SymmetryType::NONE,                                                                              //
        bifurc_verhulst_trig, nullptr, standalone_setup,                                                 //
        bifurcation,                                                                                     //
        NO_BAILOUT                                                                                       //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                          //
        SymmetryType::X_AXIS,                                                      //
        trig_plus_trig_fp_fractal, other_julia_per_pixel, trig_plus_trig_fp_setup, //
        standard_fractal,                                                          //
        TRIG_BAILOUT_L                                                             //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                     //
        SymmetryType::X_AXIS,                                                 //
        trig_x_trig_fp_fractal, other_julia_per_pixel, fn_x_fn_setup,         //
        standard_fractal,                                                     //
        TRIG_BAILOUT_L                                                        //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                       //
        SymmetryType::NONE,                                                     //
        sqr_1_over_trig_fp_fractal, other_julia_per_pixel, sqr_trig_setup,      //
        standard_fractal,                                                       //
        TRIG_BAILOUT_L                                                          //
    },

    {
        ...
        {1, 0, 1, 0},                                                                                   //
        HelpLabels::HT_TAYLOR_SKINNER_VARIATIONS, HelpLabels::HF_FN_MUL_Z_PLUS_Z,                       //
        FractalFlags::TRIG1 | FractalFlags::BAIL_TEST,                                                  //
        -4.0F, 4.0F, -3.0F, 3.0F,                                                                       //
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                               //
        SymmetryType::X_AXIS,                                                                           //
        z_x_trig_plus_z_fp_fractal, julia_per_pixel, z_x_trig_plus_z_setup,                             //
        standard_fractal,                                                                               //
        TRIG_BAILOUT_L                                                                                  //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,         //
        SymmetryType::NONE,                                       //
        (VF) kam_torus_float_orbit, nullptr, orbit3d_float_setup, //
        orbit2d_float,                                            //
        NO_BAILOUT                                                //
    },
...

    {
        ...
        SymmetryType::NONE,                                                          //
        trig_plus_z_squared_fp_fractal, julia_per_pixel, julia_fn_plus_z_sqrd_setup, //
        standard_fractal,                                                            //
        STD_BAILOUT                                                                  //
    },

    {
        ...
        SymmetryType::PI_SYM,                                             //
        lambda_trig_fp_fractal, other_julia_per_pixel, lambda_trig_setup, //
        standard_fractal,                                                 //
        TRIG_BAILOUT_L                                                    //
    },

    {
        ...
        float_z_power_fractal, other_mandel_per_pixel, mandel_per_image,         //
        standard_fractal,                                                        //
        STD_BAILOUT,                                                             //
...

    {
        ...
        SymmetryType::ORIGIN,                                                  //
        float_z_power_fractal, other_julia_per_pixel, julia_fp_setup,          //
        standard_fractal,                                                      //
        STD_BAILOUT                                                            //
    },

    {
        ...
        SymmetryType::X_AXIS_NO_PARAM,                                             //
        float_z_to_z_plus_z_pwr_fractal, other_mandel_per_pixel, mandel_per_image, //
        standard_fractal,                                                          //
        STD_BAILOUT                                                                //
    },

    {
        ...
        SymmetryType::NONE,                                                     //
        float_z_to_z_plus_z_pwr_fractal, other_julia_per_pixel, julia_fp_setup, //
        standard_fractal,                                                       //
        STD_BAILOUT                                                             //
    },

    {
        ...
        SymmetryType::X_AXIS_NO_PARAM,                                              //
        float_trig_plus_exponent_fractal, other_mandel_per_pixel, mandel_per_image, //
        standard_fractal,                                                           //
        STD_BAILOUT                                                                 //
    },

    {
        ...
        SymmetryType::NONE,                                                      //
        float_trig_plus_exponent_fractal, other_julia_per_pixel, julia_fp_setup, //
        standard_fractal,                                                        //
        STD_BAILOUT                                                              //
    },

    {
        ...
        popcorn_fractal_fn, other_julia_per_pixel, julia_fp_setup,             //
        popcorn,                                                               //
        STD_BAILOUT                                                            //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                         //
        SymmetryType::NONE,                                                       //
        (VF) lorenz3d_float_orbit, nullptr, orbit3d_float_setup,                  //
        orbit2d_float,                                                            //
        NO_BAILOUT                                                                //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                         //
        SymmetryType::NONE,                                                                       //
        complex_newton, other_julia_per_pixel, complex_newton_setup,                              //
        standard_fractal,                                                                         //
        NO_BAILOUT                                                                                //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                         //
        SymmetryType::NONE,                                                                       //
        complex_basin, other_julia_per_pixel, complex_newton_setup,                               //
        standard_fractal,                                                                         //
        NO_BAILOUT                                                                                //
    },

    {
        ...
        SymmetryType::NONE,                                                    //
        marks_cplx_mand, marks_cplx_mand_per_pixel, mandel_per_image,          //
        standard_fractal,                                                      //
        STD_BAILOUT                                                            //
    },

    {
        ...
        SymmetryType::NONE,                                                   //
        marks_cplx_mand, julia_per_pixel, julia_fp_setup,                     //
        standard_fractal,                                                     //
        STD_BAILOUT                                                           //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,    //
        SymmetryType::SETUP,                                 //
        formula, form_per_pixel, formula_setup_fp,           //
        standard_fractal,                                    //
        0                                                    //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                  //
        SymmetryType::NONE,                                                //
        sierpinski_fp_fractal, other_julia_per_pixel, sierpinski_fp_setup, //
        standard_fractal,                                                  //
        127                                                                //
    },

    {
        ...
        SymmetryType::NONE,                                  //
        lambda_fp_fractal, julia_per_pixel, julia_fp_setup,  //
        standard_fractal,                                    //
        STD_BAILOUT                                          //
    },

    {
        ...
        SymmetryType::XY_AXIS_NO_PARAM,                                 //
        barnsley1_fp_fractal, other_mandel_per_pixel, mandel_per_image, //
        standard_fractal,                                               //
        STD_BAILOUT                                                     //
    },

    {
        ...
        SymmetryType::ORIGIN,                                        //
        barnsley1_fp_fractal, other_julia_per_pixel, julia_fp_setup, //
        standard_fractal,                                            //
        STD_BAILOUT                                                  //
    },

    {
        ...
        barnsley2_fp_fractal, other_mandel_per_pixel, mandel_per_image, //
        standard_fractal,                                               //
        STD_BAILOUT                                                     //
    },

    {
        ...
        SymmetryType::ORIGIN,                                        //
        barnsley2_fp_fractal, other_julia_per_pixel, julia_fp_setup, //
        standard_fractal,                                            //
        STD_BAILOUT                                                  //
    },

    {
        ...
        SymmetryType::X_AXIS_NO_PARAM,                                  //
        barnsley3_fp_fractal, other_mandel_per_pixel, mandel_per_image, //
        standard_fractal,                                               //
        STD_BAILOUT                                                     //
    },

    {
        ...
        SymmetryType::NONE,                                          //
        barnsley3_fp_fractal, other_julia_per_pixel, julia_fp_setup, //
        standard_fractal,                                            //
        STD_BAILOUT                                                  //
    },
...

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,       //
        SymmetryType::NONE,                                     //
        (VF) rossler_float_orbit, nullptr, orbit3d_float_setup, //
        orbit3d_float,                                          //
        NO_BAILOUT                                              //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                         //
        SymmetryType::NONE,                                                       //
        (VF) henon_float_orbit, nullptr, orbit3d_float_setup,                     //
        orbit2d_float,                                                            //
        NO_BAILOUT                                                                //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,        //
        SymmetryType::NONE,                                      //
        (VF) pickover_float_orbit, nullptr, orbit3d_float_setup, //
        orbit3d_float,                                           //
        NO_BAILOUT                                               //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                         //
        SymmetryType::NONE,                                                       //
        (VF) ginger_bread_float_orbit, nullptr, orbit3d_float_setup,              //
        orbit2d_float,                                                            //
        NO_BAILOUT                                                                //
    },
...

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,        //
        SymmetryType::XY_AXIS,                                   //
        unity_fp_fractal, other_julia_per_pixel, standard_setup, //
        standard_fractal,                                        //
        NO_BAILOUT                                               //
    },
...

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                 //
        SymmetryType::X_AXIS_NO_IMAG,                                     //
        tetrate_fp_fractal, other_mandel_per_pixel, mandel_per_image,     //
        standard_fractal,                                                 //
        STD_BAILOUT                                                       //
    },
...

    {
        ...
        SymmetryType::X_AXIS_NO_IMAG,                     //
        magnet1_fractal, julia_per_pixel, julia_fp_setup, //
        standard_fractal,                                 //
        100                                               //
    },
...

    {
        ...
        SymmetryType::X_AXIS_NO_IMAG,                     //
        magnet2_fractal, julia_per_pixel, julia_fp_setup, //
        standard_fractal,                                 //
        100                                               //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                                //
        SymmetryType::NONE,                                                                              //
        bifurc_lambda_trig, nullptr, standalone_setup,                                                   //
        bifurcation,                                                                                     //
        NO_BAILOUT                                                                                       //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                                //
        SymmetryType::NONE,                                                                              //
        bifurc_add_trig_pi, nullptr, standalone_setup,                                                   //
        bifurcation,                                                                                     //
        NO_BAILOUT                                                                                       //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                                //
        SymmetryType::NONE,                                                                              //
        bifurc_set_trig_pi, nullptr, standalone_setup,                                                   //
        bifurcation,                                                                                     //
        NO_BAILOUT                                                                                       //
    },
...

    {
        ...
        SymmetryType::NONE,                                                       //
        man_o_war_fp_fractal, julia_per_pixel, julia_fp_setup,                    //
        standard_fractal,                                                         //
        STD_BAILOUT                                                               //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                        //
        SymmetryType::NONE,                                                      //
        richard_8_fp_fractal, other_richard_8_fp_per_pixel, mandel_per_image,    //
        standard_fractal,                                                        //
        TRIG_BAILOUT_L                                                           //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                             //
        SymmetryType::X_AXIS_NO_PARAM,                                                //
        marks_mandel_pwr_fp_fractal, marks_mandel_pwr_fp_per_pixel, mandel_per_image, //
        standard_fractal,                                                             //
        STD_BAILOUT                                                                   //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                       //
        SymmetryType::X_AXIS_NO_PARAM,                                          //
        tims_error_fp_fractal, marks_mandel_pwr_fp_per_pixel, mandel_per_image, //
        standard_fractal,                                                       //
        STD_BAILOUT                                                             //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                                //
        SymmetryType::NONE,                                                                              //
        bifurc_stewart_trig, nullptr, standalone_setup,                                                  //
        bifurcation,                                                                                     //
        NO_BAILOUT                                                                                       //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                         //
        SymmetryType::NONE,                                                       //
        (VF) hopalong2d_float_orbit, nullptr, orbit3d_float_setup,                //
        orbit2d_float,                                                            //
        NO_BAILOUT                                                                //
    },
...

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                         //
        SymmetryType::NONE,                                                       //
        (VF) martin2d_float_orbit, nullptr, orbit3d_float_setup,                  //
        orbit2d_float,                                                            //
        NO_BAILOUT                                                                //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,              //
        SymmetryType::NONE,                                            //
        lyapunov_orbit, nullptr, lya_setup,                            //
        lyapunov,                                                      //
        NO_BAILOUT                                                     //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,         //
        SymmetryType::NONE,                                       //
        (VF) lorenz3d1_float_orbit, nullptr, orbit3d_float_setup, //
        orbit3d_float,                                            //
        NO_BAILOUT                                                //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,         //
        SymmetryType::NONE,                                       //
        (VF) lorenz3d3_float_orbit, nullptr, orbit3d_float_setup, //
        orbit3d_float,                                            //
        NO_BAILOUT                                                //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,         //
        SymmetryType::NONE,                                       //
        (VF) lorenz3d4_float_orbit, nullptr, orbit3d_float_setup, //
        orbit3d_float,                                            //
        NO_BAILOUT                                                //
    },
...

    {
        ...
        SymmetryType::X_AXIS,                                                           //
        julia_trig_or_trig_fp_fractal, other_julia_per_pixel, julia_trig_or_trig_setup, //
        standard_fractal,                                                               //
        TRIG_BAILOUT_L                                                                  //
    },
...

    {
        ...
        SymmetryType::X_AXIS_NO_PARAM,                                                    //
        julia_trig_or_trig_fp_fractal, other_mandel_per_pixel, mandel_trig_or_trig_setup, //
        standard_fractal,                                                                 //
        TRIG_BAILOUT_L                                                                    //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                          //
        SymmetryType::NONE,                                                        //
        bifurc_may, nullptr, bifurc_may_setup,                                     //
        bifurcation,                                                               //
        NO_BAILOUT                                                                 //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, //
        SymmetryType::XY_AXIS,                            //
        halley_fractal, halley_per_pixel, halley_setup,   //
        standard_fractal,                                 //
        NO_BAILOUT                                        //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                       //
        SymmetryType::NONE,                                                     //
        (VF) dynam_float, nullptr, dynam2d_float_setup,                         //
        dynam2d_float,                                                          //
        NO_BAILOUT                                                              //
    },

    {
        ...
        SymmetryType::X_AXIS,                                             //
        quaternion_fp_fractal, quaternion_fp_per_pixel, mandel_per_image, //
        standard_fractal,                                                 //
        TRIG_BAILOUT_L                                                    //
    },
...

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                        //
        SymmetryType::NONE,                                                      //
        nullptr, nullptr, cellular_setup,                                        //
        cellular,                                                                //
        NO_BAILOUT                                                               //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, //
        SymmetryType::NONE,                               //
        julia_orbit, jb_fp_per_pixel, julibrot_setup,     //
        std_4d_fp_fractal,                                //
        STD_BAILOUT                                       //
    },
...
#ifdef RANDOM_RUN
    {
        ...
        FractalType::NO_FRACTAL, FractalType::MANDEL,                                                       //
        SymmetryType::NONE,                                                                                 //
        m_inverse_julia_orbit, nullptr, orbit3d_float_setup,                                                //
        inverse_julia_per_image,                                                                            //
        NO_BAILOUT                                                                                          //
    },
...

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,         //
        SymmetryType::NONE,                                       //
        (VF) mandel_cloud_float, nullptr, dynam2d_float_setup,    //
        dynam2d_float,                                            //
        NO_BAILOUT                                                //
    },

    {
        ...
        SymmetryType::X_AXIS,                               //
        phoenix_fractal, phoenix_per_pixel, phoenix_setup,  //
        standard_fractal,                                   //
        STD_BAILOUT                                         //
    },
...

    {
        ...
        SymmetryType::X_AXIS,                                                //
        hyper_complex_fp_fractal, quaternion_fp_per_pixel, mandel_per_image, //
        standard_fractal,                                                    //
        TRIG_BAILOUT_L                                                       //
    },
...

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, //
        SymmetryType::NONE,                               //
        froth_per_orbit, froth_per_pixel, froth_setup,    //
        calc_froth,                                       //
        FROTH_BAILOUT                                     //
    },
...

    {
        ...
        SymmetryType::ORIGIN,                                //
        mandel4_fp_fractal, julia_per_pixel, julia_fp_setup, //
        standard_fractal,                                    //
        STD_BAILOUT                                          //
    },

    {
        ...
        SymmetryType::NONE,                                                   //
        marks_lambda_fp_fractal, marks_mandel_fp_per_pixel, mandel_per_image, //
        standard_fractal,                                                     //
        STD_BAILOUT                                                           //
    },

    {
        ...
        SymmetryType::ORIGIN,                                           //
        marks_lambda_fp_fractal, julia_per_pixel, marks_julia_fp_setup, //
        standard_fractal,                                               //
        STD_BAILOUT                                                     //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                              //
        SymmetryType::NONE,                                                                            //
        (VF) icon_float_orbit, nullptr, orbit3d_float_setup,                                           //
        orbit2d_float,                                                                                 //
        NO_BAILOUT                                                                                     //
    },
...

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                         //
        SymmetryType::NONE,                                                       //
        (VF) chip2d_float_orbit, nullptr, orbit3d_float_setup,                    //
        orbit2d_float,                                                            //
        NO_BAILOUT                                                                //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                         //
        SymmetryType::NONE,                                                       //
        (VF) quadrup_two2d_float_orbit, nullptr, orbit3d_float_setup,             //
        orbit2d_float,                                                            //
        NO_BAILOUT                                                                //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                         //
        SymmetryType::NONE,                                                       //
        (VF) three_ply2d_float_orbit, nullptr, orbit3d_float_setup,               //
        orbit2d_float,                                                            //
        NO_BAILOUT                                                                //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,             //
        SymmetryType::NONE,                                           //
        vl_fp_fractal, other_julia_per_pixel, vl_setup,               //
        standard_fractal,                                             //
        256                                                           //
    },
    ...
    // code adapted from king.cpp bt James Rankin
    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                               //
        SymmetryType::NONE,                                                                             //
        (VF) latoo_float_orbit, nullptr, orbit3d_float_setup,                                           //
        orbit2d_float,                                                                                  //
        NO_BAILOUT                                                                                      //
    },
    ...
    // Jim Muth formula
    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                                //
        SymmetryType::NONE,                                                              //
        mandelbrot_mix4_fp_fractal, mandelbrot_mix4_fp_per_pixel, mandelbrot_mix4_setup, //
        standard_fractal,                                                                //
        STD_BAILOUT                                                                      //
    },

    {
        ...
        FractalType::NO_FRACTAL, FractalType::NO_FRACTAL,                        //
        SymmetryType::NONE,                                                      //
        burning_ship_orbit, other_mandel_per_pixel, mandel_setup,                //
        standard_fractal,                                                        //
        STD_BAILOUT,                                                             //
