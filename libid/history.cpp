...
void save_history_info()
{
    ...
    current.d_parm3 = g_params[2];
    current.d_parm4 = g_params[3];
    current.d_parm5 = g_params[4];
    current.d_parm6 = g_params[5];
    current.d_parm7 = g_params[6];
    current.d_parm8 = g_params[7];
    current.d_parm9 = g_params[8];
    current.d_parm10 = g_params[9];
...
void restore_history_info(int i)
{
    ...
    g_params[2] = last.d_parm3;
    g_params[3] = last.d_parm4;
    g_params[4] = last.d_parm5;
    g_params[5] = last.d_parm6;
    g_params[6] = last.d_parm7;
    g_params[7] = last.d_parm8;
    g_params[8] = last.d_parm9;
    g_params[9] = last.d_parm10;
