...
void CPertEngine::pert_functions(std::complex<double> *x_ref, std::complex<double> *delta_sub_n, std::complex<double> *delta_sub_0)
    ...
    double r = x_ref->real();
    double i = x_ref->imag();
    double a = delta_sub_n->real();
    double b = delta_sub_n->imag();
    double a2 = a * a;
    double b2 = b * b;
    double a0 = delta_sub_0->real();
    double b0 = delta_sub_0->imag();
    double ar = a * r;
    double ib = i * b;
    double ab;
    double x = r;
...
void CPertEngine::ref_functions(std::complex<double> *centre, std::complex<double> *Z, std::complex<double> *z_times_2)
	...
	case 1:
	    if (m_power == 3)
		    *Z = complex_fn.complex_cube(*Z) + *centre;			// optimise for Cubic by taking out as many multiplies as possible
	    else
		    {
