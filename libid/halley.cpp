...
int MPCHalleyFractal()
{
    ...
    {
        mpctmp2.x = *pMPsub(*MPmul386(mpcXtoAlessOne.x, s_mpc_old.x), *MPmul386(mpcXtoAlessOne.y, s_mpc_old.y));
        mpctmp2.y = *pMPadd(*MPmul386(mpcXtoAlessOne.x, s_mpc_old.y), *MPmul386(mpcXtoAlessOne.y, s_mpc_old.x));
        mpcXtoAlessOne.x = mpctmp2.x;
        mpcXtoAlessOne.y = mpctmp2.y;
    }
    mpcXtoA.x = *pMPsub(*MPmul386(mpcXtoAlessOne.x, s_mpc_old.x), *MPmul386(mpcXtoAlessOne.y, s_mpc_old.y));
    mpcXtoA.y = *pMPadd(*MPmul386(mpcXtoAlessOne.x, s_mpc_old.y), *MPmul386(mpcXtoAlessOne.y, s_mpc_old.x));
    mpcXtoAplusOne.x = *pMPsub(*MPmul386(mpcXtoA.x, s_mpc_old.x), *MPmul386(mpcXtoA.y, s_mpc_old.y));
    mpcXtoAplusOne.y = *pMPadd(*MPmul386(mpcXtoA.x, s_mpc_old.y), *MPmul386(mpcXtoA.y, s_mpc_old.x));
    ...
    mpcF1prime.x = *pMPsub(*MPmul386(s_halley_mp_a_plus_one, mpcXtoA.x), g_mp_one);
    mpcF1prime.y = *MPmul386(s_halley_mp_a_plus_one, mpcXtoA.y);                   //  F'

    mpctmp2.x = *pMPsub(*MPmul386(mpcF2prime.x, mpcFX.x), *MPmul386(mpcF2prime.y, mpcFX.y));
    mpctmp2.y = *pMPadd(*MPmul386(mpcF2prime.x, mpcFX.y), *MPmul386(mpcF2prime.y, mpcFX.x));
    //  F * F"
