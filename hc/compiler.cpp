...
void compiler::paginate_online()    // paginate the text for on-line help
{
    int size;
    int width;
 ...
 */
void compiler::set_hot_link_doc_page()
{
    LABEL *lbl;
    int    t;
 ...
 */
void compiler::set_content_doc_page()
{
    char     buf[4];
    int      len;
...
void compiler::paginate_document()
{
