...
#if 0
   LOADCHOICES("Floating Point Algorithm  (always used in this version)");
   uvalues[k].type = '*';
#endif
...
get_brws_restart:
   ...
   brwschecktype = uvalues[++k].uval.ch.val;

   brwscheckparms = uvalues[++k].uval.ch.val;
