...
extern  int    cdecl fkeypressed(void);
...
extern void identity(DMATRIX);
extern void mat_mul(DMATRIX,DMATRIX,DMATRIX);
extern void scale(double ,double ,double ,DMATRIX);
extern void xrot(double ,DMATRIX);
extern void yrot(double ,DMATRIX);
extern void zrot(double ,DMATRIX);
extern void trans(double ,double ,double ,DMATRIX);
extern int fcross_product(VECTOR,VECTOR,VECTOR);
extern int fnormalize_vector(VECTOR);
extern int vmult(VECTOR,DMATRIX,VECTOR);
