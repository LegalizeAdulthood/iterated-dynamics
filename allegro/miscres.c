...
top:
   ...
   if (display3d > 0)
      ...
      driver_put_string(s_row,16,C_GENERAL_HI,curfractalspecific->name);
      i = 0;
      if (fractype == FFORMULA)
      {
   ...
   if(bf_math==0)
   {
      ...
      driver_put_string(-1,-1,C_GENERAL_HI, sflag_is_activated);                                             
      i = 1;
   } 
   else
   {
