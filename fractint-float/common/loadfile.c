...
int read_overlay()      /* read overlay/3D files, if reqr'd */
{
   ...
   {
      /* mapping of old fractal types to new float types */
      static SIFCODE int2float[] = 
      {
         MANDELFP            ,  /* integer */ 
         JULIAFP             ,  /* integer */ 
         NEWTBASIN           ,  /* float   */ 
         ...
         MANOWARFP           ,  /* integer */ 
         TEST                ,  /* float   */ 
         SIERPINSKIFP        ,  /* integer */ 
         BARNSLEYM1FP        ,  /* integer */ 
         BARNSLEYJ1FP        ,  /* integer */ 
         BARNSLEYM2FP        ,  /* integer */ 
         BARNSLEYJ2FP        ,  /* integer */ 
         SQRTRIGFP           ,  /* integer */ 
         SQRTRIGFP           ,  /* float   */ 
         TRIGPLUSTRIGFP      ,  /* integer */ 
         MANDELLAMBDAFP      ,  /* integer */ 
         MARKSMANDELFP       ,  /* integer */ 
         MARKSJULIAFP        ,  /* integer */ 
         UNITYFP             ,  /* integer */ 
         MANDEL4FP           ,  /* integer */ 
         JULIA4FP            ,  /* integer */ 
         IFS                 ,  /* float   */ 
         IFS3D               ,  /* float   */ 
         BARNSLEYM3FP        ,  /* integer */ 
         BARNSLEYJ3FP        ,  /* integer */ 
         TRIGSQRFP           ,  /* integer */ 
         TRIGSQRFP           ,  /* float   */ 
         BIFURCATION         ,  /* float   */ 
         TRIGPLUSTRIGFP      ,  /* float   */ 
         TRIGXTRIGFP         ,  /* integer */ 
         TRIGXTRIGFP         ,  /* float   */ 
         SQR1OVERTRIGFP      ,  /* integer */ 
         SQR1OVERTRIGFP      ,  /* float   */ 
         ZXTRIGPLUSZFP       ,  /* integer */ 
         ZXTRIGPLUSZFP       ,  /* float   */ 
         KAMFP               ,  /* float   */ 
         KAMFP               ,  /* integer */ 
         KAM3DFP             ,  /* float   */ 
         KAM3DFP             ,  /* integer */ 
         LAMBDATRIGFP        ,  /* integer */ 
         FPMANTRIGPLUSZSQRD  ,  /* integer */ 
         FPJULTRIGPLUSZSQRD  ,  /* integer */ 
         FPMANTRIGPLUSZSQRD  ,  /* float   */ 
         FPJULTRIGPLUSZSQRD  ,  /* float   */ 
         LAMBDATRIGFP        ,  /* float   */ 
         MANDELTRIGFP        ,  /* integer */ 
         FPMANDELZPOWER      ,  /* integer */ 
         FPJULIAZPOWER       ,  /* integer */ 
         FPMANDELZPOWER      ,  /* float   */ 
         FPJULIAZPOWER       ,  /* float   */ 
         FPMANZTOZPLUSZPWR   ,  /* float   */ 
         FPJULZTOZPLUSZPWR   ,  /* float   */ 
         FPMANTRIGPLUSEXP    ,  /* integer */ 
         FPJULTRIGPLUSEXP    ,  /* integer */ 
         FPMANTRIGPLUSEXP    ,  /* float   */ 
         FPJULTRIGPLUSEXP    ,  /* float   */ 
         FPPOPCORN           ,  /* float   */ 
         FPPOPCORN           ,  /* integer */ 
         FPLORENZ            ,  /* float   */ 
         FPLORENZ            ,  /* integer */ 
         ...
         COMPLEXNEWTON       ,  /* float   */ 
         COMPLEXBASIN        ,  /* float   */ 
         COMPLEXMARKSMAND    ,  /* float   */ 
         COMPLEXMARKSJUL     ,  /* float   */ 
         FFORMULA            ,  /* integer */ 
         FFORMULA            ,  /* float   */ 
         SIERPINSKIFP        ,  /* float   */ 
         LAMBDAFP            ,  /* float   */ 
         ...
         BIFEQSINPI          ,  /* float   */ 
         FPPOPCORNJUL        ,  /* float   */ 
         FPPOPCORNJUL        ,  /* integer */ 
         LSYSTEM             ,  /* float   */ 
         MANOWARJFP          ,  /* float   */ 
         MANOWARJFP          ,  /* integer */ 
         FNPLUSFNPIXFP       ,  /* float   */ 
         FNPLUSFNPIXFP       ,  /* integer */ 
         MARKSMANDELPWRFP    ,  /* float   */ 
         MARKSMANDELPWRFP    ,  /* integer */ 
         TIMSERRORFP         ,  /* float   */ 
         TIMSERRORFP         ,  /* integer */ 
         BIFEQSINPI          ,  /* integer */ 
         BIFADSINPI          ,  /* integer */ 
         ...
         FPLORENZ3D3         ,  /* float   */ 
         FPLORENZ3D4         ,  /* float   */ 
         FPLAMBDAFNFN        ,  /* integer */ 
         FPLAMBDAFNFN        ,  /* float   */ 
         FPJULFNFN           ,  /* integer */ 
         FPJULFNFN           ,  /* float   */ 
         FPMANLAMFNFN        ,  /* integer */ 
         FPMANLAMFNFN        ,  /* float   */ 
         FPMANFNFN           ,  /* integer */ 
         FPMANFNFN           ,  /* float   */ 
         BIFMAY              ,  /* integer */ 
         ...
         CELLULAR            ,  /* float   */ 
         JULIBROTFP          ,  /* float   */ 
         INVERSEJULIAFP      ,  /* integer */ 
         INVERSEJULIAFP      ,  /* float   */ 
         MANDELCLOUD         ,  /* float   */ 
         PHOENIXFP           ,  /* integer */ 
         PHOENIXFP           ,  /* float   */ 
         MANDPHOENIXFP       ,  /* integer */ 
         MANDPHOENIXFP       ,  /* float   */ 
         HYPERCMPLXFP        ,  /* float   */ 
         HYPERCMPLXJFP       ,  /* float   */ 
         FROTHFP             ,  /* integer */ 
         ...
         ICON                ,  /* float   */ 
         ICON3D              ,  /* float   */ 
         PHOENIXFPCPLX       ,  /* integer */ 
         PHOENIXFPCPLX       ,  /* float   */ 
         MANDPHOENIXFPCPLX   ,  /* integer */ 
         MANDPHOENIXFPCPLX   ,  /* float   */ 
         ANT                 ,  /* float   */ 
         CHIP                ,  /* float   */ 
         QUADRUPTWO          ,  /* float   */ 
         THREEPLY            ,  /* float   */ 
   ...
   if(read_info.version > 3) {
      ...
      if(read_info.floatflag == 0)
      {
         static FCODE msg[] = 
            {"Integer math no longer supported, converting to floating point."};
         stopmsg(0,msg);
      }
...
static char typeOK( struct fractal_info *info, struct ext_blk_3 *blk_3_info )
{
 int numfn;
 int old_fractype;
   old_fractype = new_to_old(fractype);
   if( old_fractype == FFORMULA && info->fractal_type == FFORMULA)
   {
   ...
   else if(info->fractal_type == old_fractype)
   {
