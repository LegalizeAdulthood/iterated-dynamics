...
FractalTypeSpecificData g_fractal_specific[] =
{
	...
	*/
	...
	"ifs",
		{s_color_method, "", "", ""},
		{0, 0, 0, 0},
		HT_IFS, SPECIALHF_IFS, FRACTALFLAG_NO_SOLID_GUESSING | FRACTALFLAG_NO_BOUNDARY_TRACING | FRACTALFLAG_NOT_RESUMABLE | FRACTALFLAG_INFINITE_CALCULATION,
	...
	s_ifs3d_name,
		{s_color_method, "", "", ""},
		{0, 0, 0, 0},
		HT_IFS, SPECIALHF_IFS, FRACTALFLAG_NO_SOLID_GUESSING | FRACTALFLAG_NO_BOUNDARY_TRACING | FRACTALFLAG_NOT_RESUMABLE | FRACTALFLAG_3D_PARAMETERS | FRACTALFLAG_INFINITE_CALCULATION,
	...
	s_formula_name + 1,
		...
		{0, 0, 0, 0},
		HT_FORMULA, SPECIALHF_FORMULA, FRACTALFLAG_MORE_PARAMETERS,
		-2.0f, 2.0f, -1.5f, 1.5f,
		1, FRACTYPE_NO_FRACTAL, FRACTYPE_NO_FRACTAL,
	...
	s_julibrot_name + 1,
		{"", "", "", ""},
		{0, 0, 0, 0},
		HT_JULIBROT, SPECIALHF_JULIBROT, FRACTALFLAG_NO_SOLID_GUESSING | FRACTALFLAG_NO_BOUNDARY_TRACING | FRACTALFLAG_NO_ZOOM_BOX_ROTATE | FRACTALFLAG_NOT_RESUMABLE,
		-2.0f, 2.0f, -1.5f, 1.5f,
		1, FRACTYPE_NO_FRACTAL, FRACTYPE_NO_FRACTAL,
	...
	"lsystem",
		{" + Order", "", "", ""},
		{2, 0, 0, 0},
		HT_LSYS, SPECIALHF_L_SYSTEM, FRACTALFLAG_NO_ZOOM | FRACTALFLAG_NOT_RESUMABLE | FRACTALFLAG_NO_SOLID_GUESSING | FRACTALFLAG_NO_BOUNDARY_TRACING,
		-1.0f, 1.0f, -1.0f, 1.0f,
		1, FRACTYPE_NO_FRACTAL, FRACTYPE_NO_FRACTAL,
		FRACTYPE_NO_FRACTAL, SYMMETRY_NONE,
		NULL, NULL,
