...
int driver_validate_mode(VIDEOINFO *mode)
{
...
void driver_save_graphics(void)
{
	(*g_driver->save_graphics)(g_driver);
}

void driver_restore_graphics(void)
{
	(*g_driver->restore_graphics)(g_driver);
}

void driver_get_max_screen(int *g_x_max, int *g_y_max)
{
