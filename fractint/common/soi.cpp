...
void soi_long_double()
{
	...
	if (g_bf_math)
	{
		...
		yyminl = bftofloat(g_escape_time_state.m_grid_bf.y_min());
		xxmaxl = bftofloat(g_escape_time_state.m_grid_bf.x_max());
		yymaxl = bftofloat(g_escape_time_state.m_grid_bf.y_max());
	}
	else
	{
