...
struct fractalspecificstuff fractalspecific[] =
{
	...
	*/
	...
	s_mandel_name + 1,
		...
		julia_orbit, mandel_per_pixel, MandelSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_julia_name + 1,
		...
		julia_orbit, julia_per_pixel_fp, JuliaSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_newtbasin_name,
		...
		newton2_orbit, otherjuliafp_per_pixel, NewtonSetup, standard_fractal,
		BAILOUT_NONE
	},
	...
	s_lambda_name + 1,
		...
		lambda_orbit, julia_per_pixel_fp, JulialongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_julia_name,
		...
		julia_orbit_fp, juliafp_per_pixel,  JuliafpSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_mandelfn_name,
		...
		lambda_trig_orbit_fp, othermandelfp_per_pixel, MandelTrigSetup,
			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_manowar_name + 1,
		...
		man_o_war_orbit, mandel_per_pixel, MandellongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_sierpinski_name + 1,
		...
		sierpinski_orbit, julia_per_pixel, SierpinskiSetup,
				standard_fractal,
		127
	},
	...
	s_barnsleyj1_name + 1,
		...
		barnsley1_orbit, julia_per_pixel, JulialongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_barnsleyj2_name + 1,
		...
		barnsley2_orbit, julia_per_pixel, JulialongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_sqr_fn__name + 1,
		...
		sqr_trig_orbit, julia_per_pixel, SqrTrigSetup, standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_sqr_fn__name,
		...
		sqr_trig_orbit_fp, otherjuliafp_per_pixel, SqrTrigSetup, standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_fnplusfn_name + 1,
		...
		trig_plus_trig_orbit, julia_per_pixel, TrigPlusTriglongSetup,
				standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_mandellambda_name + 1,
		...
		lambda_orbit, mandel_per_pixel, MandellongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_marksjulia_name + 1,
		...
		marks_lambda_orbit, julia_per_pixel_fp, MarksJuliaSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_unity_name + 1,
		...
		unity_orbit, julia_per_pixel, UnitySetup, standard_fractal,
		BAILOUT_NONE
	},
	...
	s_mandel4_name + 1,
		...
		mandel4_orbit, mandel_per_pixel, MandellongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_julia4_name + 1,
		...
		mandel4_orbit, julia_per_pixel_fp, JulialongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_barnsleyj3_name + 1,
		...
		barnsley3_orbit, julia_per_pixel, JulialongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_fn_zz__name + 1,
		...
		trig_z_squared_orbit, julia_per_pixel_fp, JulialongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_fn_zz__name,
		...
		trig_z_squared_orbit_fp, juliafp_per_pixel, JuliafpSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_fnplusfn_name,
		...
		trig_plus_trig_orbit_fp, otherjuliafp_per_pixel, TrigPlusTrigfpSetup,
			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_fnfn_name + 1,
		...
		trig_trig_orbit, julia_per_pixel, FnXFnSetup, standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_fnfn_name,
		...
		trig_trig_orbit_fp, otherjuliafp_per_pixel, FnXFnSetup, standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_sqr_1divfn__name + 1,
		...
		sqr_1_over_trig_z_orbit, julia_per_pixel, SqrTrigSetup,
			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_sqr_1divfn__name,
		...
		sqr_1_over_trig_z_orbit_fp, otherjuliafp_per_pixel, SqrTrigSetup,
			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_fnzplusz_name + 1,
		...
		z_trig_z_plus_z_orbit, julia_per_pixel_fp, ZXTrigPlusZSetup, standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_fnzplusz_name,
		...
		z_trig_z_plus_z_orbit_fp, juliafp_per_pixel, ZXTrigPlusZSetup,
			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_lambdafn_name + 1,
		...
		(VF) lambda_trig_orbit, julia_per_pixel, LambdaTrigSetup,
			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_manfnpluszsqrd_name + 1,
		...
		trig_plus_z_squared_orbit, mandel_per_pixel, MandellongSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_julfnpluszsqrd_name + 1,
		...
		trig_plus_z_squared_orbit, julia_per_pixel_fp, JuliafnPlusZsqrdSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_julfnpluszsqrd_name,
		...
		trig_plus_z_squared_orbit_fp, juliafp_per_pixel, JuliafnPlusZsqrdSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_lambdafn_name,
		...
		lambda_trig_orbit_fp, otherjuliafp_per_pixel, LambdaTrigSetup,
			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_julzpower_name + 1,
		...
		z_power_orbit, julia_per_pixel, JulialongSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_manzpower_name,
		...
		z_power_orbit_fp, othermandelfp_per_pixel, MandelfpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_julzpower_name,
		...
		z_power_orbit_fp, otherjuliafp_per_pixel, JuliafpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	"manzzpwr",
		...
		z_to_z_plus_z_orbit_fp, othermandelfp_per_pixel, MandelfpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	"julzzpwr",
		...
		z_to_z_plus_z_orbit_fp, otherjuliafp_per_pixel, JuliafpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_julfnplusexp_name + 1,
		...
		trig_plus_exponent_orbit, julia_per_pixel, JulialongSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_manfnplusexp_name,
		...
		trig_plus_exponent_orbit_fp, othermandelfp_per_pixel, MandelfpSetup,
 			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_julfnplusexp_name,
		...
		trig_plus_exponent_orbit_fp, otherjuliafp_per_pixel, JuliafpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_popcorn_name + 1,
		...
		popcorn_fn_orbit, julia_per_pixel, JulialongSetup, popcorn,
		BAILOUT_STANDARD
	},
	...
	"cmplxmarksmand",
		...
		marks_complex_mandelbrot_orbit, MarksCplxMandperp, MandelfpSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	"cmplxmarksjul",
		...
		marks_complex_mandelbrot_orbit, juliafp_per_pixel, JuliafpSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_sierpinski_name,
		...
		sierpinski_orbit_fp, otherjuliafp_per_pixel, SierpinskiFPSetup,
			standard_fractal,
		127
	},
	...
	s_lambda_name,
		...
		lambda_orbit_fp, juliafp_per_pixel, JuliafpSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_barnsleym1_name,
		...
		barnsley1_orbit_fp, othermandelfp_per_pixel, MandelfpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_barnsleyj1_name,
		...
		barnsley1_orbit_fp, otherjuliafp_per_pixel, JuliafpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_barnsleym2_name,
		...
		barnsley2_orbit_fp, othermandelfp_per_pixel, MandelfpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_barnsleyj2_name,
		...
		barnsley2_orbit_fp, otherjuliafp_per_pixel, JuliafpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_barnsleym3_name,
		...
		barnsley3_orbit_fp, othermandelfp_per_pixel, MandelfpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_barnsleyj3_name,
		...
		barnsley3_orbit_fp, otherjuliafp_per_pixel, JuliafpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_unity_name,
		...
		unity_orbit_fp, otherjuliafp_per_pixel, StandardSetup, standard_fractal,
		BAILOUT_NONE
	},
	...
	s_spider_name + 1,
		...
		spider_orbit, mandel_per_pixel, MandellongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	"tetrate",
		...
		tetrate_orbit_fp, othermandelfp_per_pixel, MandelfpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	"magnet1j",
		...
		magnet1_orbit_fp, juliafp_per_pixel, JuliafpSetup, standard_fractal,
		100
	},
	...
	"magnet2j",
		...
		magnet2_orbit_fp, juliafp_per_pixel, JuliafpSetup, standard_fractal,
		100
	},
	...
	s_popcornjul_name + 1,
		...
		popcorn_fn_orbit, julia_per_pixel, JulialongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_manowarj_name,
		...
		man_o_war_orbit_fp, juliafp_per_pixel, JuliafpSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_manowarj_name + 1,
		...
		man_o_war_orbit, julia_per_pixel_fp, JulialongSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_fn_z_plusfn_pix__name + 1,
		...
		richard8_orbit, long_richard8_per_pixel, MandellongSetup,
			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	"circle",
		...
		circle_orbit_fp, juliafp_per_pixel, JuliafpSetup, standard_fractal,
		BAILOUT_NONE
	},
	...
	s_lambda_fnorfn__name + 1,
		...
		lambda_trig_or_trig_orbit, julia_per_pixel, LambdaTrigOrTrigSetup,
 			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_lambda_fnorfn__name,
		...
		lambda_trig_or_trig_orbit_fp, otherjuliafp_per_pixel,
	...
	s_julia_fnorfn__name + 1,
		...
		julia_trig_or_trig_orbit, julia_per_pixel, JuliaTrigOrTrigSetup,
			standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_julia_fnorfn__name,
		...
		julia_trig_or_trig_orbit_fp, otherjuliafp_per_pixel,
	...
	s_manlam_fnorfn__name,
		...
		lambda_trig_or_trig_orbit_fp, othermandelfp_per_pixel,
			ManlamTrigOrTrigSetup, standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_mandel_fnorfn__name,
		...
		julia_trig_or_trig_orbit_fp, othermandelfp_per_pixel,
			MandelTrigOrTrigSetup, standard_fractal,
		BAILOUT_TRIG_L
	},
	...
	s_halley_name + 1,
		...
		halley_orbit_mpc, MPCHalley_per_pixel, HalleySetup, standard_fractal,
		BAILOUT_NONE
	},
	...
	s_phoenix_name + 1,
		...
		phoenix_orbit, long_phoenix_per_pixel, PhoenixSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_phoenix_name,
		...
		phoenix_orbit_fp, phoenix_per_pixel, PhoenixSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_julia4_name,
		...
		mandel4_orbit_fp, juliafp_per_pixel, JuliafpSetup, standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_marksjulia_name,
		...
		marks_lambda_orbit_fp, juliafp_per_pixel, MarksJuliafpSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_phoenixcplx_name + 1,
		...
		phoenix_complex_orbit, long_phoenix_per_pixel, PhoenixCplxSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
	...
	s_phoenixcplx_name,
		...
		phoenix_complex_orbit_fp, phoenix_per_pixel, PhoenixCplxSetup,
			standard_fractal,
		BAILOUT_STANDARD
	},
