...
extern void driver_display_string(int x, int y, int fg, int bg, const std::string &text);
...
extern void driver_put_string(int row, int col, int attr, const std::string &text);
