...
extern InitializeBatchType	g_initialize_batch;
extern int					g_initial_cycle_limit;
extern ComplexD				g_initial_orbit_z;
extern ComplexL				g_initial_orbit_z_l;
...
extern ShowFileType			g_show_file;
