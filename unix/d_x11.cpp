...
int X11Driver::ev_key_press(XKeyEvent *xevent)
{
    ...
    case XK_F1:
    case XK_L1:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F1: ID_KEY_F1;
        return 1;
    case XK_F2:
    case XK_L2:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F2: ID_KEY_F2;
        return 1;
    case XK_F3:
    case XK_L3:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F3: ID_KEY_F3;
        return 1;
    case XK_F4:
    case XK_L4:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F4: ID_KEY_F4;
        return 1;
    case XK_F5:
    case XK_L5:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F5: ID_KEY_F5;
        return 1;
    case XK_F6:
    case XK_L6:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F6: ID_KEY_F6;
        return 1;
    case XK_F7:
    case XK_L7:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F7: ID_KEY_F7;
        return 1;
    case XK_F8:
    case XK_L8:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F8: ID_KEY_F8;
        return 1;
    case XK_F9:
    case XK_L9:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F9: ID_KEY_F9;
        return 1;
    case XK_F10:
    case XK_L10:
        m_key_buffer = m_shift_mode ? ID_KEY_SHF_F10: ID_KEY_F10;
        return 1;
    case '+':
...
void X11Driver::ev_button_press(XEvent *xevent)
{
    ...
    while (!done)
    {
        ...
        case MotionNotify:
            ...
            if (ABS(bandx1-bandx0)*g_viewport.final_aspect_ratio > ABS(bandy1-bandy0))
                bandy1 =
                    SIGN(bandy1-bandy0)*ABS(bandx1-bandx0)*g_viewport.final_aspect_ratio + bandy0;
            else
                bandx1 =
                    SIGN(bandx1-bandx0)*ABS(bandy1-bandy0)/g_viewport.final_aspect_ratio + bandx0;
