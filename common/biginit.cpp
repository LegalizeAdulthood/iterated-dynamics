...
bf_t g_bf_save_x_min = BIG_NULL, g_bf_save_x_max = BIG_NULL, g_bf_save_y_min = BIG_NULL, g_bf_save_y_max = BIG_NULL, g_bf_save_x_3rd = BIG_NULL, bfsy3rd = BIG_NULL;// bflength+2
