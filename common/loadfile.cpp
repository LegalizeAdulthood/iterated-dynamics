...
int read_overlay()      // read overlay/3D files, if reqr'd
{
    ...
    if (blk_6_info.got_data)
    {
                ...
                && calc_status != calc_status_value::COMPLETED)
        {
            ...
            evolve_info.discrete_x_parameter_offset = blk_6_info.odpx;
        ...
        evolve_new_y_parameter_offset = blk_6_info.opy;
        evolve_y_parameter_offset = evolve_new_y_parameter_offset;
        evolve_new_discrete_x_parameter_offset = (char) blk_6_info.odpx;
        ...
        if (info->version >= 4)
        {
            ...
            while (scan_extend)
            {
                ...
                case 6: // evolver params
                    ...
                    blk_6_info->odpx            = (char)eload_info.discrete_x_parameter_offset;
