...
double g_orbit_corner_min_x, oymin, g_orbit_corner_max_x, oymax, g_orbit_corner_3_x, oy3rd;
affine o_cvt;
static int o_color;
...
int setup_orbits_to_screen(affine *scrn_cnvt)
{
    ...
    det = (g_orbit_corner_3_x-g_orbit_corner_min_x)*(oymin-oymax) + (oymax-oy3rd)*(g_orbit_corner_max_x-g_orbit_corner_min_x);
    if (det == 0)
    {
        return (-1);
    }
    ...
    det = (g_orbit_corner_3_x-g_orbit_corner_max_x)*(oymin-oymax) + (oymin-oy3rd)*(g_orbit_corner_max_x-g_orbit_corner_min_x);
    if (det == 0)
    {
        return (-1);
    }
