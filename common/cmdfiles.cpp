...
#define PARAM_METHOD(p_, m_)            \
        { p_, &parameter_processor::m_ }

#define HANDLE_PARAM(p_, m_) PARAM_METHOD(p_, param_##m_)

#define IGNORE_PARAM(p_) PARAM_METHOD(p_, ignore_param)
...
int parameter_processor::startup_parameter()
{
    ...
    {
        HANDLE_PARAM("batch", batch),
        HANDLE_PARAM("maxhistory", max_history),
        HANDLE_PARAM("adapter", adapter),
        HANDLE_PARAM("afi", afi),
        HANDLE_PARAM("textsafe", text_safe),
        HANDLE_PARAM("vesadetect", vesa_detect),
        HANDLE_PARAM("biospalette", bios_palette),
        HANDLE_PARAM("fpu", fpu),
        HANDLE_PARAM("exitnoask", exit_no_ask),
        HANDLE_PARAM("makedoc", make_doc),
        HANDLE_PARAM("makepar", make_par),
    };
...
int parameter_processor::parameter()
{
    handler_map_t const handlers
    {
        HANDLE_PARAM("reset", reset),
        HANDLE_PARAM("filename", filename),
        HANDLE_PARAM("video", video),
        HANDLE_PARAM("map", map),
        HANDLE_PARAM("colors", colors),
        HANDLE_PARAM("recordcolors", record_colors),
        HANDLE_PARAM("maxlinelength", max_line_length),
        HANDLE_PARAM("comment", comment),
        HANDLE_PARAM("tplus", tplus),
        HANDLE_PARAM("noninterlaced", non_interlaced),
        HANDLE_PARAM("maxcolorres", max_color_res),
        HANDLE_PARAM("pixelzoom", pixel_zoom),
        HANDLE_PARAM("warn", overwrite),  // keep this for backward compatibility
        HANDLE_PARAM("overwrite", overwrite),
        HANDLE_PARAM("gif87a", gif87a),
        HANDLE_PARAM("dither", dither),
        HANDLE_PARAM("savetime", save_time),
        HANDLE_PARAM("autokey", auto_key),
        HANDLE_PARAM("autokeyname", auto_key_name),
        HANDLE_PARAM("type", type),
        HANDLE_PARAM("inside", inside),
        HANDLE_PARAM("proximity", proximity),
        HANDLE_PARAM("fillcolor", fill_color),
        HANDLE_PARAM("finattract", fin_attract),
        HANDLE_PARAM("nobof", no_bof),
        HANDLE_PARAM("function", function),
        HANDLE_PARAM("outside", outside),
        HANDLE_PARAM("bfdigits", bf_digits),
        HANDLE_PARAM("maxiter", max_iter),
        HANDLE_PARAM("passes", passes),
        HANDLE_PARAM("ismand", is_mand),
        HANDLE_PARAM("cyclelimit", cycle_limit),
        HANDLE_PARAM("makemig", make_mig),
        HANDLE_PARAM("cyclerange", cycle_range),
        HANDLE_PARAM("ranges", ranges),
        HANDLE_PARAM("savename", save_name),
        HANDLE_PARAM("tweaklzw", tweak_lzw),
        HANDLE_PARAM("minstack", min_stack),
        HANDLE_PARAM("mathtolerance", math_tolerance),
        HANDLE_PARAM("tempdir", temp_dir),
        HANDLE_PARAM("workdir", work_dir),
        HANDLE_PARAM("exitmode", exit_mode),
        HANDLE_PARAM("textcolors", text_colors),
        HANDLE_PARAM("potential", potential),
        HANDLE_PARAM("params", params),
        HANDLE_PARAM("miim", miim),
        HANDLE_PARAM("initorbit", init_orbit),
        HANDLE_PARAM("orbitname", orbit_name),
        HANDLE_PARAM("3dmode", 3d_mode),
        HANDLE_PARAM("julibrot3d", julibrot_3d),
        HANDLE_PARAM("julibroteyes", julibrot_eyes),
        HANDLE_PARAM("julibrotfromto", julibrot_from_to),
        HANDLE_PARAM("corners", corners),
        HANDLE_PARAM("orbitcorners", orbit_corners),
        HANDLE_PARAM("screencoords", screen_coords),
        HANDLE_PARAM("orbitdrawmode", orbit_draw_mode),
        HANDLE_PARAM("viewwindows", view_windows),
        HANDLE_PARAM("center-mag", center_mag),
        HANDLE_PARAM("aspectdrift", aspect_drift),
        HANDLE_PARAM("invert", invert),
        HANDLE_PARAM("olddemmcolors", old_demm_colors),
        HANDLE_PARAM("askvideo", ask_video),
        HANDLE_PARAM("float", float),
        HANDLE_PARAM("fastrestore", fast_restore),
        HANDLE_PARAM("orgfrmdir", org_frm_dir),
        HANDLE_PARAM("biomorph", biomorph),
        HANDLE_PARAM("orbitsave", orbit_save),
        HANDLE_PARAM("bailout", bailout),
        HANDLE_PARAM("bailoutest", bailout_test),
        HANDLE_PARAM("symmetry", symmetry),
        HANDLE_PARAM("sound", sound),
        HANDLE_PARAM("hertz", hertz),
        HANDLE_PARAM("volume", volume),
        HANDLE_PARAM("attenuate", attenuate),
        HANDLE_PARAM("polyphony", polyphony),
        HANDLE_PARAM("wavetype", wave_type),
        HANDLE_PARAM("attack", attack),
        HANDLE_PARAM("decay", decay),
        HANDLE_PARAM("sustain", sustain),
        HANDLE_PARAM("srelease", s_release),
        HANDLE_PARAM("scalemap", scale_map),
        HANDLE_PARAM("periodicity", periodicity),
        HANDLE_PARAM("logmap", log_map),
        HANDLE_PARAM("logmode", log_mode),
        HANDLE_PARAM("debugflag", debug_flag),
        HANDLE_PARAM("debug", debug_flag),
        HANDLE_PARAM("rseed", rseed),
        HANDLE_PARAM("orbitdelay", orbit_delay),
        HANDLE_PARAM("orbitinterval", orbit_interval),
        HANDLE_PARAM("showdot", show_dot),
        HANDLE_PARAM("showorbit", show_orbit),
        HANDLE_PARAM("decomp", decomp),
        HANDLE_PARAM("distest", dist_test),
        HANDLE_PARAM("formulafile", formula_file),
        HANDLE_PARAM("formulaname", formula_name),
        HANDLE_PARAM("lfile", l_file),
        HANDLE_PARAM("lname", l_name),
        HANDLE_PARAM("ifsfile", ifs_file),
        HANDLE_PARAM("ifs", ifs),
        HANDLE_PARAM("ifs3d", ifs),
        HANDLE_PARAM("parmfile", parm_file),
        HANDLE_PARAM("stereo", stereo),
        HANDLE_PARAM("rotation", rotation),
        HANDLE_PARAM("perspective", perspective),
        HANDLE_PARAM("xyshift", x_y_shift),
        HANDLE_PARAM("interocular", interocular),
        HANDLE_PARAM("converge", converge),
        HANDLE_PARAM("crop", crop),
        HANDLE_PARAM("bright", bright),
        HANDLE_PARAM("xyadjust", x_y_adjust),
        HANDLE_PARAM("3d", 3d),
        HANDLE_PARAM("sphere", sphere),
        HANDLE_PARAM("scalexyz", scale_x_y_z),
        HANDLE_PARAM("roughness", roughness),
        HANDLE_PARAM("waterline", waterline),
        HANDLE_PARAM("filltype", fill_type),
        HANDLE_PARAM("lightsource", light_source),
        HANDLE_PARAM("smoothing", smoothing),
        HANDLE_PARAM("latitude", latitude),
        HANDLE_PARAM("longitude", longitude),
        HANDLE_PARAM("radius", radius),
        HANDLE_PARAM("transparent", transparent),
        HANDLE_PARAM("preview", preview),
        HANDLE_PARAM("showbox", show_box),
        HANDLE_PARAM("coarse", coarse),
        HANDLE_PARAM("randomize", randomize),
        HANDLE_PARAM("ambient", ambient),
        HANDLE_PARAM("haze", haze),
        HANDLE_PARAM("fullcolor", full_color),
        HANDLE_PARAM("truecolor", true_color),
        HANDLE_PARAM("truemode", true_mode),
        HANDLE_PARAM("usegrayscale", use_gray_scale),
        HANDLE_PARAM("monitorwidth", monitor_width),
        HANDLE_PARAM("targa_overlay", targa_overlay),
        HANDLE_PARAM("background", background),
        HANDLE_PARAM("lightname", light_name),
        HANDLE_PARAM("ray", ray),
        HANDLE_PARAM("brief", brief),
        HANDLE_PARAM("release", release),
        HANDLE_PARAM("curdir", cur_dir),
        HANDLE_PARAM("virtual", virtual),

        // deprecated parameters
        IGNORE_PARAM("iterincr"),
        IGNORE_PARAM("ramvideo"),

        // deprecated print parameters
        IGNORE_PARAM("printer"),
        IGNORE_PARAM("printfile"),
        IGNORE_PARAM("rleps"),
        IGNORE_PARAM("colorps"),
        IGNORE_PARAM("epsf"),
        IGNORE_PARAM("title"),
        IGNORE_PARAM("translate"),
        IGNORE_PARAM("plotstyle"),
        IGNORE_PARAM("halftone"),
        IGNORE_PARAM("linefeed"),
        IGNORE_PARAM("comport")
    };
