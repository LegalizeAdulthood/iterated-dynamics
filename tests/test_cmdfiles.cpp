...
TEST_F(TestParameterCommand, parameterTooLong)
{
    ...
    EXPECT_EQ(cmdarg_flags::ERROR, exec_cmd_arg("maximumoftwentycharactersinparametername", cmd_file::SSTOOLS_INI));
}
...
TEST_F(TestParameterCommand, mapSpecifiesExistingFile)
{
    ...
    const cmdarg_flags result = exec_cmd_arg("map=" ID_TEST_MAP_SUBDIR SLASH ID_TEST_MAP_FILE, cmd_file::SSTOOLS_INI);
