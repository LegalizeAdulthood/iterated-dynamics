...
set(ID_TEST_IFS_SUBDIR      "ifs")
set(ID_TEST_IFS_DIR         "${ID_TEST_HOME_DIR}/${ID_TEST_IFS_SUBDIR}")
...
set(ID_TEST_SAVE_IMAGE_FILE         "save.gif")
set(ID_TEST_SAVE_IMAGE_ROOT_FILE    "save_root.gif")
...
set(ID_TEST_SAVE_DIR                "${ID_TEST_LIBRARY_DIR}/save")
configure_file("home/test.frm.in"   "${ID_TEST_LIBRARY_DIR}/${ID_TEST_FRM_FILE}" @ONLY)
configure_file("home/test.cfg.in"   "${ID_TEST_LIBRARY_DIR1}/root.cfg" @ONLY)
...
configure_file("home/test.frm.in"   "${ID_TEST_LIBRARY_DIR2}/formulas/${ID_TEST_FORMULA_FILE2}" @ONLY)
...
configure_file("home/test.map.in"   "${ID_TEST_LIBRARY_DIR2}/maps/${ID_TEST_MAP_FILE2}" @ONLY)
configure_file("home/test.par.in"   "${ID_TEST_LIBRARY_DIR2}/par/${ID_TEST_PAR_FILE}" @ONLY)
configure_file("home/test.par.in"   "${ID_TEST_LIBRARY_DIR2}/pars/${ID_TEST_PAR_FILE2}" @ONLY)
configure_file("home/test.cfg.in"   "${ID_TEST_LIBRARY_DIR3}/config/id.cfg" @ONLY)
...
configure_file("home/test.frm.in"   "${ID_TEST_SEARCH_DIR1}/formulas/${ID_TEST_FORMULA_FILE2}" @ONLY)
...
configure_file("home/test.frm.in"   "${ID_TEST_SEARCH_DIR2}/formula/${ID_TEST_FORMULA_FILE2}" @ONLY)
...
configure_file("gif/extension1.gif" "${ID_TEST_SAVE_DIR}/image/${ID_TEST_SAVE_IMAGE_FILE}" COPYONLY)
configure_file("gif/extension1.gif" "${ID_TEST_SAVE_DIR}/${ID_TEST_SAVE_IMAGE_ROOT_FILE}" COPYONLY)
