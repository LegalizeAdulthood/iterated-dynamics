...
TEST(TestStringCaseCompareCount, firstStringEmpty)
{
    ...
    EXPECT_GT(0, id::string_case_compare("", buffer, sizeof(buffer)));
}
...
TEST(TestStringCaseCompareCount, secondStringEmpty)
{
    ...
    EXPECT_LT(0, id::string_case_compare(buffer, "", sizeof(buffer)));
}
...
TEST(TestStringCaseCompareCount, firstStringExhaustedEqual)
{
    ...
    EXPECT_EQ(0, id::string_case_compare(buffer, "foobar", sizeof(buffer) - 1));
}
...
TEST(TestStringCaseCompareCount, secondStringExhaustedEqual)
{
    ...
    EXPECT_EQ(0, id::string_case_compare("foobar", buffer, sizeof(buffer) - 1));
}

TEST(TestStringCaseCompareCount, zeroLengthAlwaysEqual)
{
    EXPECT_EQ(0, id::string_case_compare("foo", "bar", 0));
}

TEST(TestStringCaseCompareCount, differOnlyByCaseEqual)
{
    EXPECT_EQ(0, id::string_case_compare("foo", "FoO", 3));
}

TEST(TestStringCaseCompareCount, differNotZero)
{
    EXPECT_LT(0, id::string_case_compare("foo", "bar", 3));
}

TEST(TestStringCaseCompareCount, lessNegative)
{
    EXPECT_GT(0, id::string_case_compare("bar", "foo", 3));
}
...
{
    EXPECT_GT(0, id::string_case_compare("frac", "fractint"));
}
...
TEST(TestStringCaseEqualCount, firstStringEmpty)
{
    ...
    EXPECT_FALSE(id::string_case_equal("", buffer, sizeof(buffer)));
}
...
TEST(TestStringCaseEqualCount, firstStringExhaustedEqual)
{
    ...
    EXPECT_TRUE(id::string_case_equal(buffer, "foobar", sizeof(buffer) - 1));
}
...
TEST(TestStringCaseEqualCount, secondStringExhaustedEqual)
{
    ...
    EXPECT_TRUE(id::string_case_equal("foobar", buffer, sizeof(buffer) - 1));
}

TEST(TestStringCaseEqualCount, zeroLengthAlwaysEqual)
{
    EXPECT_TRUE(id::string_case_equal("foo", "bar", 0));
}

TEST(TestStringCaseEqualCount, differOnlyByCaseEqual)
{
    EXPECT_TRUE(id::string_case_equal("foo", "FoO", 3));
}

TEST(TestStringCaseEqualCount, differNotZero)
{
    EXPECT_FALSE(id::string_case_equal("foo", "bar", 3));
}

TEST(TestStringCaseEqualCount, lessNegative)
{
    EXPECT_FALSE(id::string_case_equal("bar", "foo", 3));
}
...
{
    EXPECT_FALSE(id::string_case_equal("frac", "fractint", 8));
}

TEST(TestStringCaseEqual, firstStringEmptyEqual)
{
    EXPECT_FALSE(id::string_case_equal("", "foo"));
}
...
{
    EXPECT_FALSE(id::string_case_equal("foo", "foobar"));
}

TEST(TestStringCaseEqual, secondStringExhaustedGreater)
{
    EXPECT_FALSE(id::string_case_equal("foobar", "foo"));
}

TEST(TestStringCaseEqual, zeroLengthAlwaysEqual)
{
    EXPECT_TRUE(id::string_case_equal("", ""));
}

TEST(TestStringCaseEqual, differOnlyByCaseEqual)
{
    EXPECT_TRUE(id::string_case_equal("foo", "FoO"));
}

TEST(TestStringCaseEqual, differNotZero)
{
    EXPECT_FALSE(id::string_case_equal("foo", "bar"));
}

TEST(TestStringCaseEqual, lessNegative)
{
    EXPECT_FALSE(id::string_case_equal("bar", "foo"));
}
...
{
    EXPECT_FALSE(id::string_case_equal("frac", "fractint"));
}
